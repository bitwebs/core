...
func init() {
	proto.RegisterType((*LazyGradedVestingAccount)(nil), "iq.vesting.v1beta1.LazyGradedVestingAccount")
	proto.RegisterType((*Schedule)(nil), "iq.vesting.v1beta1.Schedule")
	proto.RegisterType((*VestingSchedule)(nil), "iq.vesting.v1beta1.VestingSchedule")
}

func init() {
	proto.RegisterFile("iq/vesting/v1beta1/vesting.proto", fileDescriptor_c4a9bc06e563192a)
}
