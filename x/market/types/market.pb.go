...
// source: iq/market/v1beta1/market.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "iq.market.v1beta1.Params")
}

func init() { proto.RegisterFile("iq/market/v1beta1/market.proto", fileDescriptor_114ea92c5ae3e66f) }
